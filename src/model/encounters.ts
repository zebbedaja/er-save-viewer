    ...
    npcs: [
      {
        ...
        stance: { base: 105, mult: 1, effective: 105, regenerationDelay: 8.077 },
      },
    ],
  },
  {
    ...
    npcs: [
      {
        ...
        weakPartMultiplier: 1.5,
        flagId: 10010800,
        negation: { standard: 0, strike: 0, slash: -10, pierce: 0, magic: 20, fire: 20, lightning: 20, holy: 20 },
        resistance: {
          poison: 324,
          rot: 324,
          bleed: 235,
    ...
    npcs: [
      {
        ...
        weakPartMultiplier: 1.5,
        flagId: 11000850,
        negation: { standard: 10, strike: 10, slash: 10, pierce: 0, magic: 20, fire: 20, lightning: 0, holy: 40 },
        resistance: {
          poison: 'Immune',
          rot: 'Immune',
          bleed: 'Immune',
    ...
    npcs: [
      {
        ...
        weakPartMultiplier: 1.5,
        flagId: 12030390,
        negation: { standard: 35, strike: 35, slash: 35, pierce: 35, magic: 40, fire: 20, lightning: 20, holy: 40 },
        resistance: {
          poison: 561,
          rot: 561,
          bleed: 'Immune',
    ...
    npcs: [
      {
        ...
        flagId: 12030850,
        negation: { standard: 35, strike: 35, slash: 35, pierce: 10, magic: 40, fire: 40, lightning: 80, holy: 80 },
        resistance: {
          poison: 552,
          rot: 552,
          bleed: 552,
        ...
        stance: { base: 140, mult: 0.2, effective: 700, regenerationDelay: 10.769 },
      },
    ],
  },
  {
    ...
    npcs: [
      {
        ...
        backstab: false,
        vulnerableToCriticalHit: true,
        negation: { standard: 35, strike: 35, slash: 35, pierce: 35, magic: 40, fire: 40, lightning: 40, holy: 80 },
        resistance: {
          poison: 351,
          rot: 351,
          bleed: 574,
    ...
    npcs: [
      {
        ...
        backstab: false,
        vulnerableToCriticalHit: true,
        negation: { standard: 10, strike: 10, slash: 10, pierce: 10, magic: 20, fire: 0, lightning: 20, holy: 40 },
        resistance: {
          poison: 1481,
          rot: 1481,
          bleed: 420,
    ...
    npcs: [
      {
        ...
        backstab: false,
        vulnerableToCriticalHit: true,
        negation: { standard: 10, strike: 10, slash: 0, pierce: 10, magic: 20, fire: 0, lightning: 20, holy: 40 },
        resistance: {
          poison: 367,
          rot: 367,
          bleed: 367,
  ...
  },
  {
    ...
    npcs: [
      ...
      },
      {
        ...
        weakPartMultiplier: 1.5,
        flagId: 31220800,
        negation: { standard: -10, strike: -10, slash: -40, pierce: -10, magic: 40, fire: 0, lightning: -20, holy: 0 },
        resistance: {
          poison: 185,
          rot: 185,
          bleed: 185,
    ...
    npcs: [
      {
        ...
        numberOfParries: 1,
        backstab: true,
        negation: { standard: 0, strike: 0, slash: 10, pierce: -10, magic: 0, fire: -20, lightning: 0, holy: 0 },
        resistance: {
          poison: 227,
          rot: 227,
          bleed: 227,
    ...
    npcs: [
      {
        ...
        backstab: false,
        vulnerableToCriticalHit: true,
        negation: { standard: 10, strike: 10, slash: 10, pierce: 10, magic: 20, fire: 20, lightning: 20, holy: 20 },
        resistance: {
          poison: 332,
          rot: 332,
          bleed: 332,
    ...
    npcs: [
      {
        ...
        backstab: false,
        vulnerableToCriticalHit: false,
        negation: { standard: 10, strike: -40, slash: 10, pierce: 35, magic: 20, fire: 20, lightning: 40, holy: -40 },
        resistance: {
          poison: 'Immune',
          rot: 337,
          bleed: 'Immune',
    ...
    npcs: [
      {
        ...
        stance: { base: 120, mult: 0.2, effective: 600, regenerationDelay: 9.231 },
      },
    ],
  },
  {
    ...
    npcs: [
      {
        ...
        stance: { base: 200, mult: 1, effective: 200, regenerationDelay: 15.385 },
      },
    ],
  },
  {
    ...
    npcs: [
      {
        ...
        weakPartMultiplier: 1.5,
        flagId: 2047450800,
        negation: { standard: 20, strike: 20, slash: 40, pierce: 0, magic: 20, fire: 20, lightning: -40, holy: 20 },
        resistance: {
          poison: 303,
          rot: 303,
          bleed: 416,
    ...
    npcs: [
      {
        ...
        stance: { base: 100, mult: 1, effective: 100, regenerationDelay: 6.154 },
      },
    ],
  },
  {
    ...
    npcs: [
      {
        ...
        backstab: false,
        vulnerableToCriticalHit: true,
        negation: { standard: 20, strike: 0, slash: 20, pierce: 20, magic: 40, fire: -40, lightning: 20, holy: 40 },
        resistance: {
          poison: 421,
          rot: 421,
          bleed: 'Immune',
